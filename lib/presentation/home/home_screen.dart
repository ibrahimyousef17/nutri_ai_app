...
import 'package:nutri_ai_food_calorie/presentation/home/widget/build_custom_bottom_navigation_bar.dart';
        ...
        title: GestureDetector(
          ...
          child: Row(
            children: [
              ...
              Text(
                AuthViewModel.getProvider(context).currentUser!.userName,
        ...
        actions: [
          Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(width: 1.w, color: AppColor.darkGreyColor)),
            child: Icon(
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  border:
                      Border.all(width: 1.w, color: AppColor.darkGreyColor)),
              child: Icon(
